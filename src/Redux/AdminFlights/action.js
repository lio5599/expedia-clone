...
export const addFlight = (payload) => (dispatch) => {
  ...
  axios
  .post(`${API}/flight`, payload) // https://makemytrip-api-data.onrender.com/flight
    .then(() => {
...
export const fetchFlightProducts = (limit) => (dispatch) => {
  dispatch(flightRequest());
  axios
  .get(`${API}/flight?_limit=${limit}`)   //https://makemytrip-api-data.onrender.com/flight?_limit=${limit}
    .then((res) => {
...
export const DeleteFlightProducts = (deleteId) => async (dispatch) => {
  ...
  `${API}/flight?${deleteId}`, //https://makemytrip-api-data.onrender.com/flight/${deleteId}
      {
        method: "DELETE",
        headers: {
